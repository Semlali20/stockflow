...
export function AuthFormSplitScreen({
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col md:flex-row">
      {/* Left Panel: Form */}
      <div className="flex w-full flex-col items-center justify-center bg-white dark:bg-neutral-900 p-8 md:w-1/2">
        <div className="w-full max-w-md">
          ...
          >
              ...
              >
                ...
                >
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="font-normal text-neutral-900 dark:text-neutral-100">
                            Remember Me
                          </FormLabel>
                        </div>
                      </FormItem>
                  ...
                  <a
                    ...
                    className="text-sm font-medium text-primary-600 hover:underline hover:text-primary-700 dark:text-primary-400"
                  >
                    Forgotten Password
                  </a>
                </motion.div>
            ...
            <motion.p
              variants={itemVariants}
              className="px-8 text-center text-sm text-neutral-500 dark:text-neutral-400"
            >
