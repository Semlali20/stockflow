package com.stock.purchaseservice.audit;
...
public class AuditAspect {
    ...
    private static final Map<String, String> RESOURCE_TYPE_MAP = Map.of(
        "PurchaseOrderController", "PURCHASE_ORDER",
    ...
    private String resolveAction(String httpMethod, String methodName) {
        ...
        if ("POST".equals(httpMethod)) {
            if (m.contains("send") || m.contains("receive") || m.contains("approve") ||
                m.contains("cancel") || m.contains("status")) return "STATUS_CHANGE";
            return "CREATE";
        }
