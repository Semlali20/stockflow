package com.stock.movementservice.audit;
...
public class AuditAspect {
    ...
    private static final Map<String, String> RESOURCE_TYPE_MAP = Map.of(
        ...
        "MovementLineController", "MOVEMENT_LINE",
        "MovementTaskController", "MOVEMENT_TASK",
        "MovementCsvController",  "MOVEMENT"
    );
    ...
    private String resolveAction(String httpMethod, String methodName) {
        ...
        if ("POST".equals(httpMethod)) {
            if (m.contains("validate") || m.contains("complete") || m.contains("cancel") ||
                m.contains("status")) return "STATUS_CHANGE";
            if (m.contains("import") || m.contains("csv")) return "IMPORT";
            return "CREATE";
        }
